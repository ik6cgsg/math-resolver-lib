...
data class FunctionProperties(
        ...
        val unicodeRepresentation: String = plainTextRepresentation,
...
class FunctionConfiguration(
    ...
    fun hasUpAnd() = scopeFilter.contains("setTheory")
...
//// TODO: support such functions in Double and Complex operations:
...
//            FunctionIdentifier("P", 4),
            ...
            FunctionIdentifier("implic", 2),
            FunctionIdentifier("set-", 2),
    ...
    var functionProperties = mutableListOf<FunctionProperties>(
            ...
            FunctionProperties("/", "/", 1.9, -1, texRepresentation = "\\frac", defaultStringDefinitionType = StringDefinitionType.BINARY_OPERATION, mainFunctionIsCommutativeWithNullWeight = true, notObligateMainFunction = "*"),  //FunctionProperties("/", "*", 2.0, -1)  //TODO: think about priority
            ...
            FunctionProperties("and", "and", 0.7, -1, isCommutativeWithNullWeight = true, mainFunctionIsCommutativeWithNullWeight = true, plainTextRepresentation = "&", unicodeRepresentation = "∧", texRepresentation = "\\land", defaultStringDefinitionType = StringDefinitionType.BINARY_OPERATION, fieldAddZero = "1", fieldMulZero = "0"),
            FunctionProperties("or", "or", 0.6, -1, isCommutativeWithNullWeight = true, mainFunctionIsCommutativeWithNullWeight = true, plainTextRepresentation = "|", unicodeRepresentation = "∨", texRepresentation = "\\lor", defaultStringDefinitionType = StringDefinitionType.BINARY_OPERATION, fieldAddZero = "0", fieldMulZero = "1"),
            FunctionProperties("xor", "xor", 0.6, -1, isCommutativeWithNullWeight = true, mainFunctionIsCommutativeWithNullWeight = true, plainTextRepresentation = "^", unicodeRepresentation = "⊕", texRepresentation = "\\oplus", defaultStringDefinitionType = StringDefinitionType.BINARY_OPERATION, fieldAddZero = "0"),
            FunctionProperties("alleq", "alleq", 0.4, -1, isCommutativeWithNullWeight = true, mainFunctionIsCommutativeWithNullWeight = true, plainTextRepresentation = "==", unicodeRepresentation = "≡", texRepresentation = "\\equiv", defaultStringDefinitionType = StringDefinitionType.BINARY_OPERATION),
            FunctionProperties("nand", "nand", 0.4, -1, isCommutativeWithNullWeight = true, mainFunctionIsCommutativeWithNullWeight = true, plainTextRepresentation = "↑", unicodeRepresentation = "↑", texRepresentation = "↑", defaultStringDefinitionType = StringDefinitionType.BINARY_OPERATION),
            FunctionProperties("nor", "nor", 0.4, -1, isCommutativeWithNullWeight = true, mainFunctionIsCommutativeWithNullWeight = true, plainTextRepresentation = "↓", unicodeRepresentation = "↓", texRepresentation = "↓", defaultStringDefinitionType = StringDefinitionType.BINARY_OPERATION),

            FunctionProperties("not", "not", 5.0, 1, plainTextRepresentation = "!", unicodeRepresentation = "¬", texRepresentation = "\\neg", defaultStringDefinitionType = StringDefinitionType.UNARY_LEFT_OPERATION),

            FunctionProperties("implic", "implic", 0.5, -1, plainTextRepresentation = "->", unicodeRepresentation = "→", texRepresentation = "\\implies", defaultStringDefinitionType = StringDefinitionType.BINARY_OPERATION),
            FunctionProperties("set-", "set-", 0.5, -1, plainTextRepresentation = "\\", unicodeRepresentation = "∖", texRepresentation = "\\setminus", defaultStringDefinitionType = StringDefinitionType.BINARY_OPERATION),
    ...
    var boolFunctions: Set<String> = setOf("and", "or", "not", "alleq", "xor", "implic", "set-", "nand", "nor")
    ...
    var stringDefinitions = mutableListOf<FunctionStringDefinition>(
            ...
            FunctionStringDefinition(functionPropertiesByName["and_-1"]!!, StringDefinitionType.BINARY_OPERATION, "/\\", filter = "setTheory"),
            FunctionStringDefinition(functionPropertiesByName["or_-1"]!!, StringDefinitionType.BINARY_OPERATION, "\\/"),
            ...
            FunctionStringDefinition(functionPropertiesByName["nand_-1"]!!, StringDefinitionType.BINARY_OPERATION, "↑"),
            FunctionStringDefinition(functionPropertiesByName["nor_-1"]!!, StringDefinitionType.BINARY_OPERATION, "↓"),
            ...
            FunctionStringDefinition(functionPropertiesByName["nand_-1"]!!, StringDefinitionType.FUNCTION, "nand"),
            FunctionStringDefinition(functionPropertiesByName["nor_-1"]!!, StringDefinitionType.FUNCTION, "nor"),
            ...
            FunctionStringDefinition(functionPropertiesByName["tg_1"]!!, StringDefinitionType.FUNCTION, "tg", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["ctg_1"]!!, StringDefinitionType.FUNCTION, "ctg", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["tg_1"]!!, StringDefinitionType.FUNCTION, "tan", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            ...
            FunctionStringDefinition(functionPropertiesByName["asin_1"]!!, StringDefinitionType.FUNCTION, "asin", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["acos_1"]!!, StringDefinitionType.FUNCTION, "acos", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["atg_1"]!!, StringDefinitionType.FUNCTION, "atg", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["atg_1"]!!, StringDefinitionType.FUNCTION, "atan", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["actg_1"]!!, StringDefinitionType.FUNCTION, "actg", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["asin_1"]!!, StringDefinitionType.FUNCTION, "arcsin", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["acos_1"]!!, StringDefinitionType.FUNCTION, "arccos", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["atg_1"]!!, StringDefinitionType.FUNCTION, "arctg", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["actg_1"]!!, StringDefinitionType.FUNCTION, "arcctg", definitionArgumentsCount = 1, powSeparatedAsPow = true),

            FunctionStringDefinition(functionPropertiesByName["sh_1"]!!, StringDefinitionType.FUNCTION, "sh", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["ch_1"]!!, StringDefinitionType.FUNCTION, "ch", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["th_1"]!!, StringDefinitionType.FUNCTION, "th", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["cth_1"]!!, StringDefinitionType.FUNCTION, "cth", definitionArgumentsCount = 1, powSeparatedAsPow = true),

            FunctionStringDefinition(functionPropertiesByName["sec_1"]!!, StringDefinitionType.FUNCTION, "sec", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["sec_1"]!!, StringDefinitionType.FUNCTION, "\\sec", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["csc_1"]!!, StringDefinitionType.FUNCTION, "cosec", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["csc_1"]!!, StringDefinitionType.FUNCTION, "csc", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["csc_1"]!!, StringDefinitionType.FUNCTION, "\\csc", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["sech_1"]!!, StringDefinitionType.FUNCTION, "sech", definitionArgumentsCount = 1, powSeparatedAsPow = true),
            FunctionStringDefinition(functionPropertiesByName["csch_1"]!!, StringDefinitionType.FUNCTION, "csch", definitionArgumentsCount = 1, powSeparatedAsPow = true),
    ...
    fun fastFindStringDefinitionByNameAndNumberOfArguments(name: String, numberOfArguments: Int): FunctionStringDefinition? {
        ...
        return actualStringDefinitions.firstOrNull { numberOfArguments == it.function.numberOfArguments }
                ?: actualStringDefinitions.firstOrNull { it.function.numberOfArguments == -1 }
    }

    fun fastFindByNameAndNumberOfArguments(name: String, numberOfArguments: Int) =
            functionStringDefinitionByIdentifier.get(FunctionIdentifier.getIdentifier(name, numberOfArguments))
                    ?: functionStringDefinitionByIdentifier.get(FunctionIdentifier.getIdentifier(name, -1))
...
const val notChangesOnVariablesInComparisonFunctionJsonName = "nullWeightOperations" // имеют нулевой вес всегда
const val notChangesOnVariablesInComparisonFunctionWithoutTransformationsJsonName = "lightWeightOperations" //имеют нулевой вес если не применялись другие правила преобразования

val defaultOtherCheckSolutionData = mapOf(

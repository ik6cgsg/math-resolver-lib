...
import mathhelper.twf.numbers.Form
import mathhelper.twf.numbers.Real
import mathhelper.twf.numbers.toComplex
import mathhelper.twf.optimizerutils.CompressedNode
import mathhelper.twf.optimizerutils.CompressedNodeDouble
    ...
    private val baseComputationOperations = mapOf(
            ...
            ComputationType.DOUBLE to
                    mapOf(
                            ...
                            "implic" to { listOfArgs: List<Any> ->
                                doubleFunctionToAny(listOfArgs) { args -> DoubleBaseOperation.implic(args) }
                            },
                            "set-" to { listOfArgs: List<Any> ->
                                doubleFunctionToAny(listOfArgs) { args -> DoubleBaseOperation.setMinus(args) }
                            },
...
// TODO: support such functions:
//            "S" to { listOfArgs: List<Complex> -> ComplexBaseOperation.sumN(listOfArgs) },
//            "P" to { listOfArgs: List<Complex> -> ComplexBaseOperation.prodN(listOfArgs) },
...
// TODO: support such functions:
//            "S" to { listOfArgs: List<Double> -> DoubleBaseOperation.sumN(listOfArgs) },
//            "P" to { listOfArgs: List<Double> -> DoubleBaseOperation.prodN(listOfArgs) },

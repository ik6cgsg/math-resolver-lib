...
import mathhelper.twf.factstransformations.MainChainPart
import mathhelper.twf.platformdependent.toStringWithMinLength
...
class LazyLog {
    var factConstructorViewer: FactConstructorViewer? = null
